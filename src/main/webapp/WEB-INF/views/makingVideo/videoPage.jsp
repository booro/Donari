...
<body itemscope itemtype="http://schema.org/WebSite">
	...
	<header class="header sticky scrolling" data-offset="60" itemscope
		...
		<div class="container">
			<!-- ===== LOGO ===== -->
			<h1 class="logo">
				<a href="index"><img itemprop="logo"
	...
	<!-- ===== MAIN ===== -->
	<main id="main" class="main"> <!-- ===== PAGE HEADER ===== --> <header
		class="page-header" id="vpHeader">
				...
				<div class="mt-70 mb-30">
					...
					<div class="col-sm-3 mb-40">
						...
						<ul class="footer-complement">
							<li><a href="template/travel">#Travel</a> <span>September
									29, 2017</span></li>
							<li><a href="template/movie">#Movie</a> <span>September
									18, 2017</span></li>
						</ul>
					</div>
					...
					<div class="col-sm-3 mb-40">
						...
						<ul class="social-list">
							<li class="social-item"><a href="http://www.facebook.com"
								target="_blank"><i class="fa fa-facebook"></i></a></li>
							<li class="social-item"><a href="http://twitter.com/"
								target="_blank"><i class="fa fa-twitter"></i></a></li>
							<li class="social-item"><a href="http://twitter.com/"
								target="_blank"><i class="fa fa-instagram"></i></a></li>
							<li class="social-item"><a href="http://plus.google.com/"
								target="_blank"><i class="fa fa-google-plus"></i></a></li>
							<li class="social-item"><a href="http://soundcloud.com/"
								target="_blank"><i class="fa fa-soundcloud"></i></a></li>
							<li class="social-item"><a href="http://www.pinterest.com/"
								target="_blank"><i class="fa fa-pinterest"></i></a></li>
							<li class="social-item"><a href="http://www.youtube.com/"
								target="_blank"><i class="fa fa-youtube"></i></a></li>
							<li class="social-item"><a href="http://www.spotify.com"
