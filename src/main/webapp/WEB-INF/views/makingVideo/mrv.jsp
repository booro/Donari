                  ...
                  <form name="musicUploadForm" action="fileUploads" method="post"
                     ...
                     <div>
                        <img id="musicUploadBtn"
                           ...
                           style="float: left; margin-left: 250px; margin-top: 90px;">
                     </div>
                     <div>
                        <input type="text" size="30" id="musicFileName"
                           readonly="readonly"
                           style="width:200px; background-color: transparent; border: solid black thin 3px; margin-top: 20px;  margin-left: 200px;">
                     </div>
