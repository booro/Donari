      ...
      for (int i = 0; i < imgs.length; i++) {
         ...
         if (i == 0) {
            ...
            if (map.get(""+i)!=null) {
               ...
               mv.insertText(inputPath, outputPath, map.get(""+i), "default", "default", "default", "center", "center", "0", "3");
               inputPath = outputPath;
            }
            System.out.println("0번째사진 끝");
            mv.insertFadeIn(inputPath, PROCESSED_VIDS+imgName+".mp4", "0", "3");
         }
         ...
         //시작2
            ...
            if (map.get(""+i)!=null) {
               String outputPath = PROCESSING_VID+imgName+"t.mp4";
               mv.insertText(inputPath, outputPath, map.get(""+i), "default", "default", "default", "center", "center", "0", "2");
               inputPath = outputPath;
            }
            
            mv.insertFadeIn(inputPath, PROCESSED_VIDS+imgName+".mp4", "0", "2");
         }
         ...
         //타이틀자막
            ...
            if (map.get(""+i)!=null) {
               String outputPath = PROCESSING_VID+imgName+"t.mp4";
               mv.insertText(inputPath, outputPath, map.get(""+i), "gulim.ttc", "default", "default", "center", "center", "0", "2");
               inputPath = outputPath;
            }
            mv.insertFadeIn(inputPath, PROCESSED_VIDS+imgName+".mp4", "0", "2");
         }
         ...
         //짧은 전환 씬
            ...
            if (map.get(""+i)!=null) {
               String outputPath = PROCESSING_VID+imgName+"t.mp4";
               mv.insertText(inputPath, outputPath, map.get(""+i), "gulim.ttc", "default", "default", "center", "center", "0", "1.5");
               inputPath = outputPath;
            }
            mv.insertFadeIn(inputPath, PROCESSED_VIDS+imgName+".mp4", "0", "0.5");
         }
